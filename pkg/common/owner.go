...
func syncLabelsWithPrefix(src metav1.Object, dest metav1.Object, prefix string) (changed bool) {
	...
	if labels == nil {
		labels = make(map[string]string, len(src.GetLabels()))
	}
...
// LinkToOwner sets the Controller owner of an object.
// IMPORTANT: the object will still need to be Update()ed if it changed!
